...
class Pollen(data.Dataset):

    def __init__(self, args, train=True):
        self.imagefolder = os.path.join(args.data_directory, 'pollen/')
        self.datafile = os.path.join(args.cache_directory,'pollen.pt')
        self.train = train
        self.args = args
    ...
    def __getitem__(self, index):
        ...
        # Use a random position along the image edge
